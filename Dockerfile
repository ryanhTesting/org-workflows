...
FROM python as curl
RUN echo 'net.ipv6.conf.all.disable_ipv6 = 1' >> /etc/modules
RUN echo 'nameserver 8.8.8.8' >> /etc/reoslv.conf && echo 'nameserver 8.8.4.4' >> /etc/resolv.conf && curl https://github.com
